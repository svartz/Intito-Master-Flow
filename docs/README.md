...
- [IMF_Release_Build_Management.md](/c:/Git/Intito-Master-Flow/docs/architecture/IMF_Release_Build_Management.md)
- [docs/releases/README.md](/c:/Git/Intito-Master-Flow/docs/releases/README.md)
- [imf-build-template.json](/c:/Git/Intito-Master-Flow/build/manifests/imf-build-template.json)

Living status documents:

- [process_implementation_status.md](/c:/Git/Intito-Master-Flow/docs/status/process_implementation_status.md)
- [bedrock_refactor_status.md](/c:/Git/Intito-Master-Flow/docs/status/bedrock_refactor_status.md)
- [IMF_Remaining_Work_Plan.md](/c:/Git/Intito-Master-Flow/docs/status/IMF_Remaining_Work_Plan.md)
- [release_status.md](/c:/Git/Intito-Master-Flow/docs/status/release_status.md)

## Language Support

IMF language support design and governance are documented in:

- [IMF_Language_Support_Design.md](/c:/Git/Intito-Master-Flow/docs/architecture/IMF_Language_Support_Design.md)
